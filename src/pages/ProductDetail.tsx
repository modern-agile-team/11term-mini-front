...
const ProductDetail = () => {
  ...
  if (!product) return <div className="py-40 text-center text-gray-400 font-bold">상품 정보가 없습니다.</div>;
        ...
        <div className="flex-1 flex flex-col justify-between py-2 pr-4">
          <div>
            ...
            <div className="border-t border-gray-100 pt-6 space-y-4">
              <div className="flex text-sm"><span className="text-gray-400 w-24">• 상품상태</span><span className="text-gray-800 font-medium">사용감 없음</span></div>
              <div className="flex text-sm"><span className="text-gray-400 w-24">• 거래지역</span><span className="text-gray-800 font-medium">📍 {product.location}</span></div>
            </div>
          </div>
          ...
          <div className="flex gap-2 mt-8">
            ...
            <button className="flex-1 h-14 bg-[#ffa800] text-white font-bold rounded hover:brightness-95 transition">번개톡</button>
            <button className="flex-[1.2] h-14 bg-[#ff5058] text-white font-bold rounded hover:brightness-95 transition">바로구매</button>
          </div>
        </div>
      </div>
    </div>
