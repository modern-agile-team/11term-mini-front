      ...
      <div className="max-w-[1024px] mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10 mb-10 text-[13px] text-gray-500 leading-6">
          ...
          <div className="w-[300px]">
            ...
            <div className="mt-8">
              ...
              <p>
                번개장터(주)는 회사가 직접 판매하는 상품에 한하여, 고객님의 현금 결제 금액에 대해
        ...
        <div className="flex flex-col md:flex-row gap-6 pt-8 border-t border-gray-100 items-start">
          ...
          <p className="text-[11px] text-gray-400 leading-5">
            번개장터(주)는 통신판매중개자이며, 통신판매의 당사자가 아닙니다. 전자상거래 등에서의
            소비자보호에 관한 법률 등 관련 법령 및 번개장터(주)의 약관에 따라 상품, 상품정보, 거래에
            관한 책임은 개별 판매자에게 귀속하고, 번개장터(주)는 원칙적으로 회원간 거래에 대하여
            책임을 지지 않습니다. 다만, 번개장터(주)가 직접 판매하는 상품에 대한 책임은
            번개장터(주)에게 귀속합니다.
          </p>
        </div>
      </div>
